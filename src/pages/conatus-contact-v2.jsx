...
function ContactForm() {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="m-form-row" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginBottom: 20 }}>
        <div>
...
function MainContent() {
  return (
    <section style={{ padding: 'clamp(48px, 5vw, 80px) 5%', maxWidth: 1280, margin: '0 auto' }}>
      <div className="m-grid-stack" style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1.2fr) minmax(280px, 0.8fr)', gap: 'clamp(32px, 4vw, 56px)', alignItems: 'start' }}>
        {/* Left - Form */}
        <FadeIn>
      ...
      <div style={{ maxWidth: 980, margin: '0 auto' }}>
        ...
        <div style={{ borderTop: `1px solid ${U.navy}` }}>
          {[
            ...
            <details key={i} className="m-faq-item" style={{ borderBottom: `1px solid ${U.rule}`, padding: '20px 0' }}>
              <summary className="m-faq-summary" style={{
                ...
                <span className="m-faq-plus" style={{ fontFamily: Ufonts.display, fontSize: 22, color: U.gold, textAlign: 'right' }}>+</span>
              </summary>
              <div className="m-faq-answer" style={{ display: 'grid', gridTemplateColumns: '64px 1fr 28px', gap: 16, marginTop: 12 }}>
